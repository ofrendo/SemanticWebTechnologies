...
\end{figure}
%TODO Sascha: Missing: Why do we need to have SPARQL 1.1?
...
%TODO Sascha: Example for regex? Shortened names for example
...
%TODO: Why is this the most expensive?
...
%TODO: Würde hier ein beispiel einer gruppe geben wie im proposal
