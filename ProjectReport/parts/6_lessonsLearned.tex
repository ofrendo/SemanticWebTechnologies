...
%OLLI: Vielleicht noch beschreiben, warum dieser Button sein muss? Wie gesagt, bei anderen Plugins scheint es ja einen Weg zu geben. Wäre mit dem impossible auf jeden Fall sehr vorsichtig ;)
