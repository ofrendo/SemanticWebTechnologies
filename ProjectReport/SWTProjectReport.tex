...
\begin{titlepage}
	\vspace*{2cm}
  \begin{center}
   {\Large Entity Annotation\\}
   \vspace{2cm} 
   {Project Report: IE650 Semantic Web Technologies\\}
   \vspace{2cm}
   {presented by\\
...
\input{parts/1_application} %Olli
\input{parts/2_datasets} %Sascha
\input{parts/3_techniques} % both
\input{parts/4_sampleResults} %Olli
\input{parts/5_knownLimitations} %both
\input{parts/6_lessonsLearned} %both
